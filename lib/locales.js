...
export const locales = {
  fa: {
    ...
    portfolio: {
      tag: 'نمونه‌کارها',
      title: 'نمونه‌کارها',
      subtitle: 'ویدیوهای منتخب به‌زودی در این بخش قرار می‌گیرند.',
      ...
      projects: [
        {
          title: 'نمونه‌کار ۱',
          description: 'ویدیوی افقی؛ عنوان، توضیح و لینک پس از بارگذاری اضافه می‌شود.',
          tags: ['افقی'],
        },
        {
          title: 'نمونه‌کار ۲',
          description: 'ویدیوی عمودی؛ عنوان، توضیح و لینک پس از بارگذاری اضافه می‌شود.',
          tags: ['عمودی'],
        },
        {
          title: 'نمونه‌کار ۳',
  ...
  en: {
    ...
    portfolio: {
      tag: 'Portfolio',
      title: 'Portfolio',
      subtitle: 'Selected videos will be added here soon.',
      ...
      projects: [
        {
          title: 'Project 1',
          description: 'Horizontal video; title, description, and link will be added after upload.',
          tags: ['Horizontal'],
        },
        {
          title: 'Project 2',
          description: 'Vertical video; title, description, and link will be added after upload.',
          tags: ['Vertical'],
        },
        {
          title: 'Project 3',
